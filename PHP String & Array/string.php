...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo "Kalimat Pertama: ".$first_sentence;
        echo "<br> Panjang String: ".strlen($first_sentence);
        echo "<br> Jumlah Kata: ". str_word_count($first_sentence). "<br>";
        
        echo "<br> Kalimat Kedua: ".$second_sentence;
        ...
        */
        ...
        echo "Ganti kata: " .str_replace("sexy", "awesome", $string3);
