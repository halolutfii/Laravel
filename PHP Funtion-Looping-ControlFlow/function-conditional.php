...
function greetings($strNama) {
    echo "Halo $strNama, Selamat Datang di Sanbercode!"."<br>";
}
...
function reverse($kata1){
    $panjangParameter = strlen($kata1);
    $tampung = "";
    for($index = $panjangParameter - 1 ; $index >=0;   $index--){
        $tampung .=$kata1[$index];
    }
    return $tampung;
}
...
reverseString("Lutfi Cahya Nugraha");
...
function palindrome($pali){
    ...
    //     echo "$pali => False<br>";
    // }
    echo $pali === $balik ? "$pali => True <br>" : "$pali => False <br>";
}
